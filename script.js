  ...
  if (aceptado) {
    ...
    cuerpoApp.innerHTML = `
      <div class="Aplicacion-exito">
        ...
        <p class="Aplicacion-texto-exito">
          ...
          quizas pienses que me alejo pero la verdad es que no es asi moy, la oscuridad de mi corazon desperto y me siento mas triste porque,
          me lleva nuevamente a ese lugar de odio  solo quiero que sepas que me siento muy orgullo de ti por ser mas fuerte que yo 🥺.
        </p>
        <p class="Aplicacion-texto-exito">
          Espero que este dia, esté lleno de alegría y amor para ti, mi moy 🥺. Que sea un día tan especial como tú.
        </p>
    ...
    cuerpoApp.innerHTML = `
      <div class="Aplicacion-cuerpo">
        ...
        <p class="Aplicacion-texto">My Moy 🥺, ¿Qué tal si hablamos un poco? Me encantaría contarte por qué. ¿Te gustaría saberlo?</p>
    ...
    cuerpoApp.innerHTML = `
      <div class="Aplicacion-cuerpo">
        <h1>👋 Hola Mi Moy 🥺 🎉</h1>
        <img class="Aplicacion-gif" src="${gifFloroso}" alt="👋 Hola Mi Moy 🥺 🎉" />
        <p class="Aplicacion-texto">Sabes Moy, ¿Qué tal si hablamos un poco? Me encantaría contarte por qué. ¿Te gustaría saberlo?</p>
        <button class="Aplicacion-boton aceptar" onclick="manejarAceptacion(); reproducirMusica()">Sí</button>
        <button class="Aplicacion-boton rechazar" onclick="manejarRechazo()">${textoNoBoton}</button>
      </div>
    `;
